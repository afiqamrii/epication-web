                    ...
                    <table style="margin-bottom:50px;max-width: 100%;">
                        <c:forEach var="item" items="${trips}">
                            <tr>
                                ...
                                <td style="width:45vw;">
                                    <p>Name : <strong>${item.tripName}</strong></p>
                                ...
                                <td style="text-align: center">
                                    <a href="editTripRet?tripID=${item.tripID}" class="btn-book-now">Edit</a><br><br><br><br>
                                    <a href="deleteTrip?tripID=${item.tripID}" class="btn-book-now">Delete</a>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
